        ...
        for _ in range(self.capacity):
            if self.map[index] is None:
                if first_tombstone is not None:
                    self.map[first_tombstone].key = key
                    self.map[first_tombstone].value = value
                else:
                ...
                return
            elif self.map[index].key is None and first_tombstone is None:
